...
git add src/lib/tickets.ts src/components/history/HistoryScreen.tsx
echo.
echo === Committing ===
git commit -m "history: keep clocked-out manicurists in today's turns list + tickets phantom-dupe fix"
echo.
